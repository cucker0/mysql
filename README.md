...
* [SQL语言](./SQL语言.md)
    ...
    * [变量](./7_01_变量.md)
        ...
        * [自定义变量](./变量.md#自定义变量)
            ...
            * [用户变量](./变量.md#用户变量)
            * [局部变量](./变量.md#局部变量)
        * [全局变量、会话变量、用户变量、局部变量对比](./变量.md#全局变量会话变量用户变量局部变量对比)
    * [存储过程、用户定义函数](./8_01_存储过程、用户定义函数.md)
        ...
        * [用户自定义函数](./8_02_用户定义函数.md)
            * [函数创建语法](./用户定义函数.md#函数创建语法)
            * [调用用户自定义函数语法](./用户定义函数.md#调用用户自定义函数语法)
            * [创建函数示例](./用户定义函数.md#创建函数示例)
            * [查看用户自定义函数](./用户定义函数.md#查看用户自定义函数)
            * [删除自定义用户函数](./用户定义函数.md#删除自定义用户函数)
            * [修改用户自定义函数(不能更改函数体和参数列表，只能更改函数特性)](./用户定义函数.md#修改用户自定义函数不能更改函数体和参数列表只能更改函数特性)
    * [流程控制结构](./9_01_流程控制结构.md)
        * [流程控制结构分类](./流程控制结构.md#流程控制结构分类)
        * [分支结构](./流程控制结构.md#分支结构)
            * [if函数](./流程控制结构.md#if函数)
            * [IFNULL(expr1,expr2)](./流程控制结构.md#IFNULLexpr1expr2)
            * [if分支](./流程控制结构.md#if分支)
            * [case结构](./流程控制结构.md#case结构)
        * [循环结构](./流程控制结构.md#循环结构)
            * [循环控制](./流程控制结构.md#循环控制)
            * [while循环](./流程控制结构.md#while循环)
            * [loop无限循环](./流程控制结构.md#loop无限循环)
            * [repeat循环](./流程控制结构.md#repeat循环)
            * [循环示例](./流程控制结构.md#循环示例)
* 其他
