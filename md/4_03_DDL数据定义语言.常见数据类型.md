...
:--- |:--- |:--- |:--- |:--- |:--- 
VARCHAR |L+N |String |12 | |可保存java中timezone、locale、currency等数据 
CHAR |N |String |1 | | 
BLOB |L+N |byte[] |-4 | | 
TEXT |65535 |String |-1 | | 
BIT |1 |Boolean |-7 | | 
...
INT / INTEGER |11 |无 |4 |java.lang.Long |Integer只与有符号的INT对应 
...
BOOLEAN |1 | | | |同TINYINT(1) 
DATE | |java.sql.Date |91 |java.sql.Date | 
